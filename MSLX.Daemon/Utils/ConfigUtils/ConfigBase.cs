...
public static class IConfigBase
{
    ...
    public static PluginConfigService GetPluginConfigService(string pluginId)
    {
        return _pluginConfigs.GetOrAdd(pluginId, id => new PluginConfigService(id));
    }
    ...
    public static string GetAppDataPath()
    {
        bool isMacAppBundle = PlatFormServices.GetOs() == "MacOS" &&
                              AppContext.BaseDirectory.Contains(".app/Contents/MacOS",
