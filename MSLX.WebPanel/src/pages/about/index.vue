      ...
      <div class="flex flex-col gap-5">
          ...
          <div class="mb-5 pb-4 border-b border-dashed border-zinc-200/70 dark:border-zinc-700/60 flex items-center justify-between">
            <div class="flex items-center gap-3">
              ...
              <div class="flex flex-col">
                ...
                <span class="text-xs text-[var(--td-text-color-secondary)] mt-1.5 font-medium">全新一代跨平台开服工具</span>
              </div>
            </div>
          </div>

          <div class="bg-zinc-50/80 dark:bg-zinc-800/50 p-5 rounded-xl border border-[var(--td-component-border)] text-sm leading-relaxed text-zinc-700 dark:text-zinc-300 shadow-sm transition-colors hover:bg-white dark:hover:bg-zinc-800">
            <p class="mb-3">
              <strong class="text-[var(--color-primary)] font-extrabold tracking-wide">MSLX</strong> 是由 <strong class="text-[var(--td-text-color-primary)] font-bold">MSL 原班团队 MSLTeam</strong> 倾力打造的全新一代开服工具。 基于
          ...
          <div class="mb-5 pb-4 border-b border-dashed border-zinc-200/70 dark:border-zinc-700/60 flex items-center">
            <div class="flex items-center gap-3">
              ...
              <div class="flex flex-col">
                ...
                <span class="text-xs text-[var(--td-text-color-secondary)] mt-1.5 font-medium">感谢以下开发者对本项目的杰出贡献</span>
              </div>
            </div>
          </div>

          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div v-for="dev in developers" :key="dev.name" class="group flex items-center bg-zinc-50/80 dark:bg-zinc-800/50 p-4 rounded-xl border border-[var(--td-component-border)] transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:border-[var(--color-primary)]/50 hover:bg-white dark:hover:bg-zinc-800">
              ...
              <div class="ml-4 flex-1 min-w-0">
                ...
                <div class="text-xs text-[var(--td-text-color-secondary)] truncate font-medium" :title="dev.desc">{{ dev.desc }}</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="mb-5 pb-4 border-b border-dashed border-zinc-200/70 dark:border-zinc-700/60 flex items-center">
            <div class="flex items-center gap-3">
              ...
              <div class="flex flex-col">
                ...
                <span class="text-xs text-[var(--td-text-color-secondary)] mt-1.5 font-medium">请点击下方按钮......</span>
              </div>
            </div>
          </div>
          <hurry-upppppppp />
          ...
          <div class="mb-5 pb-4 border-b border-dashed border-zinc-200/70 dark:border-zinc-700/60 flex items-center">
            <div class="flex items-center gap-3">
              ...
              <div class="flex flex-col">
                ...
                <span class="text-xs text-[var(--td-text-color-secondary)] mt-1.5 font-medium">特别感谢参与内测并提供宝贵反馈的伙伴们</span>
              </div>
            </div>
          </div>

          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <div v-for="tester in testers" :key="tester.name" class="group flex items-center bg-zinc-50/80 dark:bg-zinc-800/50 p-4 rounded-xl border border-[var(--td-component-border)] transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:border-[var(--color-success)]/50 hover:bg-white dark:hover:bg-zinc-800">
              ...
              <div class="ml-4 flex-1 min-w-0">
                ...
                <div class="text-xs text-[var(--td-text-color-secondary)] truncate font-medium" :title="tester.desc">{{ tester.desc }}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="design-card list-item-anim flex flex-col bg-[var(--td-bg-color-container)]/80  rounded-2xl border border-[var(--td-component-border)] shadow-sm p-6" style="animation-delay: 0.2s;">
          <div class="mb-5 pb-4 border-b border-dashed border-zinc-200/70 dark:border-zinc-700/60 flex items-center justify-between">
            <div class="flex items-center gap-3">
              ...
              <div class="flex flex-col">
                ...
                <span class="text-xs text-[var(--td-text-color-secondary)] mt-1.5 font-medium">查看 MSLX 历史版本的所有改动记录</span>
              </div>
            </div>
          ...
          <div v-if="updateLogs.length > 0" class="max-h-[400px] overflow-y-auto custom-scrollbar pr-2">
            <t-timeline>
              <t-timeline-item v-for="(log, index) in updateLogs" :key="index" dot-color="primary">
                <div class="bg-zinc-50/80 dark:bg-zinc-800/50 p-4 rounded-xl border border-[var(--td-component-border)] ml-1 transition-colors hover:bg-white dark:hover:bg-zinc-800">
                  <div class="flex items-center gap-3 mb-2">
                    ...
                    <div class="flex items-center gap-1 text-xs text-[var(--td-text-color-secondary)] font-mono font-medium">
                      <time-icon size="14px" />
                      {{ log.time }}
                    </div>
                  </div>
          ...
          <div v-else-if="!logLoading" class="flex justify-center items-center py-10">
            <span class="text-sm font-medium text-[var(--td-text-color-secondary)] bg-zinc-50 dark:bg-zinc-800/50 px-4 py-2 rounded-full border border-[var(--td-component-border)]">暂无更新日志</span>
          </div>
        </div>
        ...
        <div class="design-card list-item-anim flex flex-col bg-[var(--td-bg-color-container)]/80  rounded-2xl border border-[var(--td-component-border)] shadow-sm p-6" style="animation-delay: 0.25s;">
          <div class="mb-5 pb-4 border-b border-dashed border-zinc-200/70 dark:border-zinc-700/60 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div class="flex items-center gap-3">
              ...
              <div class="flex flex-col">
                ...
                <span class="text-xs text-[var(--td-text-color-secondary)] mt-1.5 font-medium">系统底层的实时编译数据与核心依赖版本</span>
              </div>
            </div>
          ...
          <template v-if="buildInfo">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              <div class="bg-zinc-50/80 dark:bg-zinc-800/50 p-4 rounded-xl border border-[var(--td-component-border)] flex flex-col justify-center transition-colors hover:bg-white dark:hover:bg-zinc-800">
              ...
              <div class="bg-zinc-50/80 dark:bg-zinc-800/50 p-4 rounded-xl border border-[var(--td-component-border)] flex flex-col justify-center transition-colors hover:bg-white dark:hover:bg-zinc-800" :title="buildInfo.commitMsg">
                ...
                <div class="text-[11px] text-[var(--td-text-color-secondary)] mt-1 truncate font-medium">by {{ buildInfo.commitAuthor }}</div>
              </div>
              <div class="bg-zinc-50/80 dark:bg-zinc-800/50 p-4 rounded-xl border border-[var(--td-component-border)] flex flex-col justify-center transition-colors hover:bg-white dark:hover:bg-zinc-800">
            ...
            <div class="border-t border-dashed border-zinc-200/70 dark:border-zinc-700/60 pt-4">
              <t-collapse :borderless="true">
                <t-collapse-panel value="history">
                  <template #header>
                    <div class="flex items-center gap-2 font-bold text-sm text-zinc-700 dark:text-zinc-300 bg-zinc-50/80 dark:bg-zinc-800/50 p-3 px-4 rounded-xl border border-[var(--td-component-border)] hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors">
                  ...
                  <div class="max-h-[300px] overflow-y-auto custom-scrollbar mt-3 pl-1 pr-2">
                    <t-timeline>
                      <t-timeline-item v-for="item in buildInfo.history" :key="item.commitId" dot-color="primary">
                        <div class="bg-zinc-50/50 dark:bg-zinc-800/30 p-3.5 rounded-xl border border-[var(--td-component-border)] ml-1 transition-colors hover:bg-white dark:hover:bg-zinc-800">
                          <div class="text-[11px] text-[var(--td-text-color-secondary)] font-mono mb-1.5 font-medium">{{ item.commitTime }}</div>
                          <div class="text-sm text-[var(--td-text-color-primary)] font-medium mb-3 leading-snug">{{ item.commitMsg }}</div>
                          <div class="flex items-center gap-2">
                            ...
                            <span class="text-[11px] font-mono font-medium text-[var(--td-text-color-secondary)] bg-zinc-100 dark:bg-zinc-900 px-1.5 py-0.5 rounded border border-[var(--td-component-border)]">#{{ item.commitId.substring(0, 7) }}</span>
                          </div>
                        </div>
                      </t-timeline-item>
                    </t-timeline>
                ...
                <t-collapse-panel value="dependencies">
                  <template #header>
                    <div class="flex items-center gap-2 font-bold text-sm text-zinc-700 dark:text-zinc-300 bg-zinc-50/80 dark:bg-zinc-800/50 p-3 px-4 rounded-xl border border-[var(--td-component-border)] hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors mt-2">
                      <code-icon class="opacity-80" /> 核心依赖 (Dependencies)
                    </div>
                  </template>
                  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 mt-3">
                    <div v-for="dep in dependenciesList" :key="dep.name" class="flex items-center justify-between p-2.5 px-3.5 bg-zinc-50/80 dark:bg-zinc-800/50 border border-[var(--td-component-border)] rounded-lg shadow-sm transition-colors hover:bg-white dark:hover:bg-zinc-800 hover:border-[var(--color-primary)]/30">
                      <span class="text-xs font-bold text-zinc-700 dark:text-zinc-300 truncate mr-3" :title="dep.name">{{ dep.name }}</span>
                      <span class="text-[10px] font-mono font-bold px-1.5 py-0.5 rounded bg-zinc-200/50 dark:bg-zinc-700/50 text-[var(--td-text-color-secondary)] shrink-0">{{ dep.version }}</span>
                    </div>
                  </div>
                </t-collapse-panel>
              </t-collapse>
